                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                    {articles
                        ...
                        .map((article) => (
                            <div
                                key={article._id}
                                className="flex flex-col border border-green-200 bg-white rounded-lg overflow-hidden shadow hover:shadow-lg transition transform hover:-translate-y-1"
                            >
                                <img
                                    src={article.image}
                                    alt={article.title}
                                ...
                                <div className="p-4 flex flex-col flex-grow">
                                    ...
                                    <button
                                        ...
                                        className="mt-4 px-4 py-2 rounded font-semibold bg-green-600 text-white hover:bg-green-700 transition"
                                    >
                                        View Details
                                    </button>
                                </div>
